...
def make_xhtml_end():
    return u"""<p class="publicdomain">Les photos et le programme qui a servi a générer cette page sont dans le domaine public. Vous pouvez <a href="https://www.almacha.org/svn/cml_gometz/places/">consulter le code source du programme</a>.</p>\n""" \
